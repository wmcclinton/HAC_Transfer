...
class Layer():
    ...
    def perform_action_replay(self, env, hindsight_action, next_state, goal_status):
    ...
    def train(self, agent, env, subgoal_test = False, episode_num = None):
        ...
        while True:
            ...
            if not agent.FLAGS.test:
                ...
                self.perform_action_replay(env, hindsight_action, agent.current_state, goal_status)
